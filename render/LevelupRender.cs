...
namespace WeaponMasterDefense
{
    public class LevelUpRender
    {
        ...
        public void DrawLevelUpMenu()
        {
            ...
            RenderSystem.TextRender("CHOOSE YOUR BUFF", 110, 13, "S", ConsoleColor.White, ConsoleColor.Black);
            RenderSystem.TextRender("PRESS NUMBER", 120, 20, "S", ConsoleColor.White, ConsoleColor.Black);

            // 옵션들 출력
            RenderSystem.TextRender("PRESS 1 TO RESUME", 5, 32, "S", ConsoleColor.White, ConsoleColor.Black);
            RenderSystem.TextRender("PRESS 2 TO EXIT", 5, 42, "S", ConsoleColor.White, ConsoleColor.Black);
        }
    }
}
